    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Startup Academy</h3>
            <p className="text-gray-400">
              Empowering entrepreneurs with knowledge, mentorship, and resources to build successful startups.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Email: support@startupacademy.com</li>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8">
          <p className="text-center text-gray-400">
            © {new Date().getFullYear()} Startup Academy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
